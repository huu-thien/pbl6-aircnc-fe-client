  ...
  return (
    <div className='max-w-7xl mx-auto w-full py-8'>
      ...
      <p className=' font-extralight text-sm'>
        Người thuê có thể hủy phòng trong 48h trước khi checkin và được hoàn trả 100% tiền đặt phòng. Nếu sau thời gian
        đó thì bên cho thuê được trả tiền cho mỗi đêm đã ở và đêm tiếp theo. Cụ thể như sau:
      </p>
      <p className=' font-thin text-sm'>
        - Nếu người thuê chưa ở đêm nào thì tính tiền 1 đêm (không tính chi phí dọn dẹp)
      </p>
      <p className=' font-thin text-sm pb-5'>- Đã ở ⅗ đêm thì tính ⅘ đêm (có tính chi phsi dọn dẹp)</p>

      <Button variant='contained'>Yêu cầu đặt phòng</Button>
    </div>
  );
};
